                ...
                >
                  <div
                    className={`max-w-[80%] px-3 py-2 rounded-2xl shadow-sm ${
                      m.from === "user" ? "bg-orange-100 text-orange-900" : "bg-green-50 text-green-900"
                    }`}
                  >
                      ...
                      <div className="mt-2 grid grid-cols-1 gap-2">
                        {m.products.map((p) => (
                          ...
                          >
                            ...
                            <a
                              href={`/product/${p.id}`}
                              className="text-xs font-medium bg-orange-500 text-white px-2 py-1 rounded-lg hover:bg-orange-600 transition"
                            >
                              Lihat
                            </a>
                          </div>
